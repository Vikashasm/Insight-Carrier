  ...
  return (
    <div className="relative overflow-hidden pb-12">
      ...
      <div className="container xl:max-w-[1280px] mx-auto px-5 z-[1] relative">
        <h1 className="ff_poppins font-semibold text-3xl md:text-5xl lg:text-[54px] text-[#611D69] text-center mt-10">
          Insight. <span className="text-[#00ADEF]">Leads.</span> Growth.
        </h1>
        <div className="flex justify-center mt-6 items-center gap-1.5 sm:gap-2.5 ">
          <CommonBtn
            path="/register"
            btnName="start now"
            btnStyling="font-bold text-[15px] text-white flex !py-3.5 !px-10 gap-6 items-center bg-[#611D69] !uppercase"
          />

          <CommonBtn
            path="/register"
            btnName="subscribe"
            btnStyling="font-bold text-[15px] text-[#611D69] !py-3.5 !px-10 flex gap-6 items-center border border-[#611D69] !uppercase  hover:text-white hover:bg-[#611D69] duration-300"
          />
        </div>
        ...
        <div className="w-full sm:w-8/12 mx-auto mt-12 lg:mt-20 relative">
          <span
        ...
        <p className="font-bold text-xl md:text-2xl text-[#1D1D1D] mt-6 lg:mt-[60px] text-center">By choosing Insight Carrier, you gain access to a robust, data-driven platform tailored to meet the demands of today’s trucking insurance market. Our daily updated leads and comprehensive safety reports give you the competitive edge needed to identify and connect with high-potential clients, streamline your underwriting process, and manage risk effectively. Whether you’re expanding your client base or optimizing your services, Insight Carrier equips you with the insights and tools to grow confidently in a rapidly evolving industry.</p>
      </div>
    </div>
  );
};
